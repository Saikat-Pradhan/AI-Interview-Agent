...
const Step3Report = ({ report }) => {
  ...
  const downloadPDF = () => {
    ...
    autoTable(doc, {
      ...
      columnStyles: {
        0: { cellWidth: 17, halign: "center" }, // index
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8'>
      <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        ...
        <button
          onClick={downloadPDF}
          className='bg-emerald-600 hover:bg-emerald-700 text-white px-3 py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap cursor-pointer'
        >
          Download PDF
        </button>
      </div>
          ...
          >
            ...
            <div className='space-y-6'>
              {questionWiseScore.map((q, i) => (
                <div
                  key={i}
                  className='bg-gray-50 p-4 rounded-xl sm:rounded-2xl border border-gray-200'
                >
