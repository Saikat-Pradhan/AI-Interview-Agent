...
const Step2Interview = ({ interviewData, onFinish }) => {
  ...
  const videoSource = (selectedVoice === maleVoice) ? maleVideo : femaleVideo
  ...
  useEffect(() => {
    ...
    const runIntro = async () => {
      ...
      if (isIntroPhase) {
        ...
        await speakText(
          `Hi ${userName.split(" ")[0]}, it's great to meet you today. I hope you're feeling confident and ready.`
        );
