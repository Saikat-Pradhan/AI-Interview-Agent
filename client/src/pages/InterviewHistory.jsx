                ...
                <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
                  <div>
                    <div className='flex gap-6 items-center'>
                      ...
                      <div onClick={(e) => e.stopPropagation()}>
                        ...
                        {openDeleteId === item._id && (
                          <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white text-center shadow-lg rounded p-3 z-50'>
                    ...
                    <p className='text-gray-500 text-sm mt-1'>
                      {item.experience} <span className='font-bold text-black'>--</span> {item.mode}
                    </p>
